...
####################################################
  ...
  Generalpath= labelInput
  #############################################################
  PATHPoints=paste0(Generalpath,"\\Points\\", date, ".shp") 
  pthTable=paste0(Generalpath,"\\", date,"_table.csv")
  pthPointsTable=paste0(Generalpath,"\\", date,"Points.csv")
