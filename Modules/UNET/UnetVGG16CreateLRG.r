...
unt <- function(shape, nlevels = 4, nfilters = 16, dropouts = c(0.1, 0.1, 0.2, 0.2, 0.3)){
...
#########################################################
unet1 <<- unt(shape = c(256, 256, 3), nlevels = 4, nfilters = 64, dropouts = c(0.1, 0.4, 0.5, 0.6,0.7))
