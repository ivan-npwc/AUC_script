...
if(dir.exists(PolygonDir)==F){
  dir.create(PolygonDir)
  dir.create(ObserverCountDir)
   dir.create(AnimalMeasurDir)
   dir.create(HauloutDir)
   dir.create(RookeryDir)
  dir.create(ExcludeDir)
   dir.create(ModelPolDir)
  }
