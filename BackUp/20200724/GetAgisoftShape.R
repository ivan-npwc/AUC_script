...
OPP_InfoTablePth=paste0(labelinput1,"\\Agisoft_IMG_INFO_",basename(labelinput1),".csv")
 date1=basename(OPP_folder)
  pth.doc.zip=paste0(OPP_folder,"\\",date1,".files\\0\\0\\frame.zip")
  if (file.exists(pth.doc.zip)==F){pth.doc.zip=paste0(OPP_folder,"\\",date1,".files\\1\\0\\frame.zip")}
