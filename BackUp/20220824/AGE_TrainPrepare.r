 ...
 TblAgeRef=NULL
 AgeRefRow1=NULL
 SelectedCategory=    c("An","TF","TN","AN","AF","F","J","SA","Sa","P","Bch")   #c("F") #c("J") # c("Sa") c("P")     #
  ...
  ObsCountDir=paste0(labelInput,"\\Observer count")
   if (dir.exists(ObsCountDir)==F){ObsCountDir=paste0(labelInput,"\\Observer_count")}
