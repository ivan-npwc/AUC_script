...
library(magick) 
	      ...
	      mdlPTH_NFS_SSLa_SSLp = paste0(System_data,"/weights/NFS_AGE/NFSageBASE/SSL_adult_P_NFS_crop__20220919_loss_0.03_epoch_02.h5")
...
for (i in 1:length(lstimgs)) {
   ...
   # preds3$name[preds3$SSLadult < 0.98]="NFS"
###############
SSLimgsP=NULL
