...
####################################################################################################                     
tabPanel("Export",
         fluidRow(  column(3, selectInput("SpeciesG", "SpeciesG", c("All"="", c("EJ","CU")), multiple=TRUE)),
				          	column(3,selectInput("YearG", "YearG", c("All"="", c("2016","2017","2018","2019")), multiple=TRUE)),
