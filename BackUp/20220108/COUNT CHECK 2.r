...
SQLite_path ="C:\\Users\\Admin\\Desktop\\138_2016-2020 NFS  SSL as 20210206.db"
...
query=paste0("CREATE TABLE count (type_count TEXT,
                    r_year INT, 
					site INT, 
					r_date DATE,
					time_start TIME,
					...
					model_name TEXT,
					comments TEXT, 
PRIMARY KEY (r_year,site,r_date,time_start,animal_type,observer,local_site,species), 
