 ...
 ############################################################################################          
           tabPanel("CIC",
                 ...
                 fluidRow(column(width = 12, selectInput('Bath_Process', 'Bath Process', width="1000px",multiple = T,
														...
														#  "00_CreateModelPolygons"="CreateModelPolygons",
														...
														# "04_MaskAutoCreator" = "MaskAutoCreator",
														 ...
														 #"03.1_IMAGE_SPLIT"="IMAGE_SPLIT",										  
                                                          "04_Unet"="04_Predict_tf2",
														#  "04_Unet_NFS_SSL_PUP"="Unet_NFS_SSL_PUP",
														 # "04.05_Unet.Blob_analisisPUP"="UnetBlobAnalisPUP",														  
                                                          "05_Blob_analisis"="BlobAnalys",
														 # "05_BlobAnalysNFS-SSL"="BlobAnalysNFS-SSL",
                                                          "06_Geo_ref"="Geo_ref",
														#  "06_Geo_ref_NFS pup 256"="05_Geo_ref_NFS pup 256",
                                                          "07_KML"="KML",
														 # "06_KML_NFS Pup PRB 256" = "06_KML_NFS Pup PRB 256",
														 # "07.1_KML_rewrite"="KML_rewrite",
												
                                                         
                                                         # "--------------------------------------------"="B",
														#  "09_LRG_Measurements_Prepare"="LRG_SplitPredByBlob",
														#  "10_LRG_Measurements_Predict"="LRG_PREDICT",
                                                         "08_SSL-NFS_Age_PREPROCESING"= "Age_PREPROCESING",
														...
														# "9_NFS_Age_PREDICT"="Age_PREDICT_NFS",
														# "10_Age_predict_optimisation"="Age_predict_optimisation",
			...
			fluidRow(column(3, conditionalPanel("input.Bath_Process=='Save'",
			     ...
			     fluidRow(column(width = 11,selectInput('Species', 'Species', width="200px",multiple = F,
                                                         c("NFS_Adult"="NFSAdult",
                                                           "SSL_Adult"="SSLAdult",
                                                           "NFS_Pup256"="NFSPup256",
														   "NFS_Pup512"="NFSPup512",
                                                           "SSL_Pup"="SSLPup",
														   "WLRS"="WLRS",
														   "LARGHA"="LRG"),
...
tabPanel("Settings",	 
        ...
        hr(),
         ...
         hr(),
		  fluidRow(column(width = 12,actionLink('NFS_AN_TF_UNET',label= paste0("NFS_AN_TF_UNET:  ", NFS_AN_TF_UNET), style = "font-size:12px;"))),
         hr(),
            fluidRow(column(width = 12,actionLink('NFS_Pup_weight_pth',label= paste0("NFS_Pup_weight_pth256:  ", NFS_Pup_weight_pth), style = "font-size:12px;"))),
			 hr(),
            fluidRow(column(width = 12,actionLink('NFS_Pup_weight_pth512',label= paste0("NFS_Pup_weight_pth512:  ", NFS_Pup_weight_pth512), style = "font-size:12px;"))),
         hr(),
