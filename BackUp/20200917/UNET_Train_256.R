UnetTrain256=function (trainDir1=trainDir,
                       weight1="_",#Weight,
					   ...
					   BatchIntens=  2,  #BatchIntens1,  # all train set will be procesing in one epoch 3 times
					   Split=Split1	,        # if split for train and validate
					   Smooth=Smooth1,       # smoth for accuracy model estimate  
