...
#####################################################
#preds3$link512=gsub("Rookery_256","Rookery",preds3$link)
#preds3$link512=gsub("Haulout_256","Haulout",preds3$link)
######################################################
SSLimgsP=NULL
...
SSLimgsP=SSLimgsP[! "Rookery" %in% SSLimgsP]
...
SSLimgsA=SSLimgsA[! "Rookery" %in% SSLimgsA]
...
SSLimgs1=SSLimgs[! "Rookery" %in%  SSLimgs]
