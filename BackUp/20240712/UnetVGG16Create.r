...
unet1 <- function(shape, nlevels = 4, nfilters = 16, dropouts = c(0.5, 0.5, 0.5, 0.5, 0.5)){
...
#########################################################
unet1 <- unet1(shape = c(256, 256, 3), nlevels = 4, nfilters = 64, dropouts = c(0.5, 0.5, 0.5, 0.5,0.5))
