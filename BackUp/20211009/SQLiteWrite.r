...
#  local_site="No_info"
  ...
  photo_count_list <<- data.frame(r_year,site, r_date,time_start,observer,comments=CommentsPCL,
                            type="Acount",datecreated,species,type_count=type_count)
							 
						 
  count_effort<<- data.frame(r_year,site,r_date, time_start, type="Acount",local_site,creator=observer, comments=CommentsPCL,
