 ...
 ############################################################################################          
           tabPanel("CIC",
                 ...
                 fluidRow(column(width = 11, selectInput('Bath_Process', 'Bath Process', width="1000px",multiple = T,
														...
														#  "09_LRG_Measurements_Prepare"="LRG_SplitPredByBlob",
														 # "10_LRG_Measurements_Predict"="LRG_PREDICT",
														  ...
														  "09.1_Age_PREDICT_FALSE_POSITIVE"="Age_PREDICT_FALSE_POSITIVE",
			...
			fluidRow(column(3, conditionalPanel("input.Bath_Process =='Save'",
                                     selectInput("type", "type", c("manual_count_full","auto_count_full","manual_count_model"), multiple=F,selected=type),
									 selectInput('site', 'site', width="1000px",multiple = F, c("138","30","19","20","82","71"),selected=site)
                                                                 ))),
														#############
			fluidRow(column(3, conditionalPanel("input.Bath_Process=='SaveToExcell'",
                                    selectInput('site', 'site', width="1000px",multiple = F, c("138","30","19","20","82","71"),selected=site)
                                                                 ))),
														############
