...
library(magick) 
	      ...
	      mdlPTH_NFS_SSLa_SSLp = paste0(System_data,"/weights/NFS_AGE/NFSageBASE/P_NFS_crop__20220921_loss_0.00_epoch_01.h5")
...
#    preds3$name[preds3$name=="SSLpup" & preds3$SSLpup < 0.99]="NFS"
###############
SSLimgsP=NULL
