...
library(magick) 
	      ...
	      mdlPTH_NFS_SSLa_SSLp = paste0(System_data,"/weights/NFS_AGE/NFSageBASE/SSLp_256_SSLa_256_NFS_256__20220923_loss_0.09_epoch_09.h5")
		  ...
		  SLLdirA=paste0(labelInput,"\\Predict\\",Species,"\\SSLadult"); unlink(SLLdirA,recursive=T);dir.create(SLLdirA,showWarnings = F)
          SLLdirP=paste0(labelInput,"\\Predict\\",Species,"\\SSLpup");  unlink(SLLdirP,recursive=T);dir.create(SLLdirP,showWarnings = F)	  
