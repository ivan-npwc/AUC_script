...
#	median(abs(sp::coordinates(SpP_data)[1:100,2]-sp::coordinates(SpP_data)[2:101,2]))), what = "centers") 
		...
		grid_1 <- SpP_data_1 %>% 
	  st_make_grid(cellsize = c(median(abs(sp::coordinates(SpP_data)[1:1000,1]-sp::coordinates(SpP_data)[2:1001,1])), # 
	median(abs(sp::coordinates(SpP_data)[1:1000,2]-sp::coordinates(SpP_data)[2:1001,2]))), what = "centers") 
