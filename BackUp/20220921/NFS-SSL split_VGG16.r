...
library(magick) 
	      ...
	      mdlPTH_NFS_SSLa_SSLp = paste0(System_data,"/weights/NFS_AGE/NFSageBASE/SSL_adult_P_NFS_crop__20220920_loss_0.04_epoch_01.h5")
		  mdlPTH_NFS_SSLa = paste0(System_data,"/weights/NFS_AGE/NFSageBASE/NFS-SSL__20220902_loss_0.19_epoch_02.h5")
		  
	      WeightPTH_NFS_SSLa_SSLp =  paste0(System_data,"/weights/NFS_AGE/SSL_adult_P_NFS_crop__20220919_loss_003_epoch_02")
...
for (i in 1:length(lstimgs)) {
    ...
    preds3$name[preds3$name=="SSLadult" &  preds3$SSLadult < 0.95 ]="NFS" 
    preds3$name[preds3$name=="SSLpup" & preds3$SSLpup < 0.95]="NFS"
###############
SSLimgsP=NULL
