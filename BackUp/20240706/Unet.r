...
if (Species== "NFSPup") { PTHweight=NFS_Pup_weight_pth; predict_dir=paste0(labelInput,"\\Predict\\NFSPup\\ALL")}
...
##############################################################################  
  ...
  if(exists("unet1")==F) {source("Modules/unetVGG16Create.r")} #& Species != "NFSPup"
