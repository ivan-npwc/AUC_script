...
Report=list(date1=basename(labelInput),
	...
	print(as.tibble(Report$Compare1))
	print(as.tibble(data.frame(observerCountAdult=observerCountAdult,TottalErrorIndivid=TottalErrorIndivid,TottalErrorPercent=TottalErrorPercent)))
	
	source("C:\\Users\\usato\\SSL_DB\\AUC\\Modules\\FP_FN.r")
